...
# 默认配置（数据库无配置时使用）
DEFAULT_CONFIGS = {
    TASK_CODE_REDELIVERY: {"interval_seconds": 60, "enabled": False},
    TASK_CODE_RATE: {"interval_seconds": 20, "enabled": False},
    TASK_CODE_POLISH: {"interval_seconds": 60, "enabled": False},
    TASK_CODE_DAY_SWITCH: {"interval_seconds": 60, "enabled": False},
    TASK_CODE_CLEANUP_BROWSER_DATA: {"interval_seconds": 600, "enabled": False},
    TASK_CODE_FETCH_ORDERS: {"interval_seconds": 600, "enabled": False},
    TASK_CODE_FETCH_PENDING_ORDERS: {"interval_seconds": 60, "enabled": False},
    TASK_CODE_FETCH_REFUND_ORDERS: {"interval_seconds": 120, "enabled": False},
    TASK_CODE_FETCH_ITEMS: {"interval_seconds": 1200, "enabled": False},
    TASK_CODE_LOGIN_RENEW: {"interval_seconds": 600, "enabled": False},
    TASK_CODE_COOKIES_REFRESH: {"interval_seconds": 600, "enabled": False},
    TASK_CODE_API_COOKIE_RENEW: {"interval_seconds": 3600, "enabled": False},
    TASK_CODE_CLOSE_NOTICE: {"interval_seconds": 600, "enabled": False},
    TASK_CODE_RED_FLOWER: {"interval_seconds": 300, "enabled": False},
    TASK_CODE_DB_BACKUP: {"interval_seconds": 3600, "enabled": True},
    TASK_CODE_DELIVERY_TIMEOUT: {"interval_seconds": 60, "enabled": True},
    TASK_CODE_LISTING_MONITOR: {"interval_seconds": 60, "enabled": False},
    TASK_CODE_SELLER_FILL: {"interval_seconds": 60, "enabled": False},
    TASK_CODE_DM_SEND: {"interval_seconds": 60, "enabled": False},
    TASK_CODE_AUTO_ORDER: {"interval_seconds": 60, "enabled": False},
}
